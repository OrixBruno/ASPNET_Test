...
.PARAMETER Clean
Removes the image aspnetcoreteste and kills all containers based on that image.
...
Build a Docker image named aspnetcoreteste
#>
...
$imageName="aspnetcoreteste"
$projectName="aspnetcoreteste"
$serviceName="aspnetcoreteste"
